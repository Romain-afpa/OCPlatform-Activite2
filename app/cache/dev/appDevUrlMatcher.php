    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/platform')) {
            ...
            if (0 === strpos($pathinfo, '/platform/purge') && preg_match('#^/platform/purge/(?P<days>\\d+)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'oc_platform_purge')), array (  '_controller' => 'OC\\PlatformBundle\\Controller\\PurgeController::purgeAction',));
            }
